...
public class StCloudNugenConsumerDRTest extends TestBaseRoxiePRQATools {

	@Test
	@Timeout(group = Group.SLOW)
	public void testStCloudNugenConsumerDRTest() throws Exception {
		...
		driver.findElement(By.xpath("//*[@id='job-wizard-submit_current_compare4713']/span")).click();
		Thread.sleep(2000);
		...
		/*
		 * // Click Server link driver.findElement(By.id("service-44-server-count-ones")).click();
		 * 
		 ...
		 * Thread.sleep(5000); System.out.println("server table closed"); // Service Type
		 * driver.findElement(By.xpath("/html/body/div[2]/div/div/div[2]/form/div/div[2]/div/div/button[2]")).click();
		 * Thread.sleep(10000); System.out.println("clicked service button");
		 */
		...
		driver.findElement(By.id("job-description")).sendKeys(properties.getProperty("app.descriptionStCloudNugenConsumerDR"));

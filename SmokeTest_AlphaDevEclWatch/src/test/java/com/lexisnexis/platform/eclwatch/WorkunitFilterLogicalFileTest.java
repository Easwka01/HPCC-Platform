...
public class WorkunitFilterLogicalFileTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testWorkunitFilterLogicalFileTest() throws Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.id("stub_ECL-DL_Workunits-DLJobname")).sendKeys(properties.getProperty("JobName"));

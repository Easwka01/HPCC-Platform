...
public class MainFilesXrefTest extends TestBaseBocaDev {
	...
	public void testMainFilesXrefTest() throws Exception {
		...
		assertEquals("thor400_dev01_2", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_Xref-DLGrid-row-thor400_dev01_2']/table/tr/td[2]/a")).getText().trim());
		assertEquals("thor50_dev01_2", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_Xref-DLGrid-row-thor50_dev01_2']/table/tr/td[2]/a")).getText().trim());
		assertEquals("thor400_sta01_2", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_Xref-DLGrid-row-thor400_sta01_2']/table/tr/td[2]/a")).getText().trim());
		assertEquals("thor400_dev02_2", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_Xref-DLGrid-row-thor400_dev02_2']/table/tr/td[2]/a")).getText().trim());
		assertEquals("thor50_dev05_2", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_Xref-DLGrid-row-thor50_dev05_2']/table/tr/td[2]/a")).getText().trim());

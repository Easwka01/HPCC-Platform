...
public class WorkunitSelectDownloadToCSVTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testWorkunitSelectDownloadToCSVTest() throws Exception {
		...
		driver.findElement(By.xpath("//*[@id=\"stub_ECL-DL_Workunits-DLDownloadToList_label\"]/span")).click();
		Thread.sleep(4000);

		// Wait for the Export Selection
		waitForCSVExportDialogload();

		// Enter file to export to CSV
		driver.findElement(By.id("stub_ECL-DL_Workunits-DLFileName")).sendKeys(properties.getProperty("ExportFileName"));
		driver.findElement(By.id("stub_ECL-DL_Workunits-DLonDownloadSubmit_label")).click();
		Thread.sleep(2000);

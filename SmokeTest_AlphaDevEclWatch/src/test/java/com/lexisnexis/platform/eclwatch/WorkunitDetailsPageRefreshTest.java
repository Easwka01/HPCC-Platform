...
public class WorkunitDetailsPageRefreshTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testWorkunitDetailsPageRefreshTest() throws Exception {
		...
		driver.findElement(By.id("stub_ECL-DL_Workunits-DL_W20190313x144456-DLRefresh_label")).click();
		Thread.sleep(10000);

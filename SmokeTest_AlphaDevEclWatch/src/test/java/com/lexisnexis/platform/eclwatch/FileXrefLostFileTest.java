...
public class FileXrefLostFileTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testXrefLostFileTest() throws Exception {
		...
		// Click on Lost File
		driver.findElement(By.id("stub_Files-DL_Xref-DL_thor400x126-DLTabContainer_tablist_stub_Files-DL_Xref-DL_thor400x126-DL_LostFiles")).click();
		Thread.sleep(3000);
		waitForXrefLostFileToLoadAlphDev();
		Thread.sleep(2000);

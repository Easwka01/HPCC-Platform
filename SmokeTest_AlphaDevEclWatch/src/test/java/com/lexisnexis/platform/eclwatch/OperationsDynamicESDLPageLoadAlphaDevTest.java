...
public class OperationsDynamicESDLPageLoadAlphaDevTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testOperationsDynamicESDLPageLoadAlphaDevTest() throws Exception {
		...
		// Click on Dynamic ESDL Link
		driver.findElement(By.id("stub_OPS-DLStackController_stub_OPS-DL_DESDL_label")).click();
		System.out.println("Cluster Processes page loaded");
		waitForOperationsDynamicESDLPageLoad();

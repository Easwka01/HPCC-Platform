...
public class OperationsSystemServersPageLoadAlphaDevTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testOperationsSystemServersPageLoadAlphaDevTest() throws Exception {
		...
		// Click on System servers Link
		driver.findElement(By.id("stub_OPS-DLStackController_stub_OPS-DL_SystemServersQuery_label")).click();
		System.out.println("System Servers page loaded");
		waitForOperationsSystemServersPageLoadAlphaDev();

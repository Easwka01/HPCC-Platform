...
public class LogicalFilesFilterDropDownTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFilesFilterDropDownTest() throws Exception {
		...
		driver.findElement(By.id("stub_Files-DL_LogicalFiles-DLFilterFilterDropDown"));
		Thread.sleep(2000);

...
public class LogicalFiles_File_ECLTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFiles_File_ECLTest() throws Exception {
		...
		// Click on ECL tab
		driver.findElement(By.id("stub_Files-DL_LogicalFiles-DL_hthorxxdevxeclagentxxxxxadvtest1-DLTabContainer_tablist_stub_Files-DL_LogicalFiles-DL_hthorxxdevxeclagentxxxxxadvtest1-DL_Source")).click();
		Thread.sleep(3000);
		waitForLogicalFiles_File_ECLTable();
		assertEquals("STRING field1;", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_LogicalFiles-DL_hthorxxdevxeclagentxxxxxadvtest1-DL_Source-DLEclContent']/div/div[6]/div[1]/div/div/div/div[5]/div[2]/pre/span")).getText().trim());

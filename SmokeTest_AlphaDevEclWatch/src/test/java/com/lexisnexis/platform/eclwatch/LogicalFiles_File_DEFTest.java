...
public class LogicalFiles_File_DEFTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFiles_File_DEFTest() throws Exception {
		...
		// Click on DEF tab
		driver.findElement(By.id("stub_Files-DL_LogicalFiles-DL_hthorxxdevxeclagentxxxxxadvtest1-DLTabContainer_tablist_stub_Files-DL_LogicalFiles-DL_hthorxxdevxeclagentxxxxxadvtest1-DL_DEF")).click();
		Thread.sleep(3000);
		waitForLogicalFiles_File_DEFTable();
		assertEquals("UNKNOWN char field1", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_LogicalFiles-DL_hthorxxdevxeclagentxxxxxadvtest1-DL_DEF-DLEclContent']/div/div[6]/div[1]/div/div/div/div[5]/div[1]/pre/span")).getText().trim());

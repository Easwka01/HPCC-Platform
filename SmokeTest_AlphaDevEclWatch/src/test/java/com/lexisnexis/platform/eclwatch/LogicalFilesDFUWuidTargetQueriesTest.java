...
public class LogicalFilesDFUWuidTargetQueriesTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFilesDFUWuidTargetQueriesTest() throws Exception {
		...
		driver.findElement(By.id("stub_Main-DL_Search-DL_DetailD20180404x102850-DL_DestLogicalName-DLTabContainer_tablist_stub_Main-DL_Search-DL_DetailD20180404x102850-DL_DestLogicalName-DL_Queries")).click();
		Thread.sleep(2000);
		System.out.println("Queries Tab Clicked");

		waitForLogicalFilesDFUWuidTargetQueriesToLoad();
		Thread.sleep(2000);
		System.out.println("DFUWUID Target Queries Tab verified");

...
public class WorkunitPageRefreshTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testWorkunitPageRefreshTest() throws Exception {
		...
		driver.findElement(By.id("stub_ECL-DL_Workunits-DLRefresh_label")).click();
		Thread.sleep(5000);
		System.out.println("Workunits page should be loaded");
		waitForWorkunitspagetoload();

...
public class OperationsDiskUsagePageLoadAlphaDevTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testOperationsDiskUsagePageLoadAlphaDevTest() throws Exception {
		...
		// Click on Disk Usage Link
		driver.findElement(By.id("stub_OPS-DLStackController_stub_OPS-DL_DiskUsage_label")).click();
		System.out.println("DiskUsage page loaded");
		waitForOperationsDiskUsagePageLoad();

...
public class PublishedQueriesSuspendAlphaDevTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testPublishedQueriesSuspendAlphaDevTest() throws Exception {
		...
		driver.findElement(By.id("stub_RoxieQueries-DL_Queries-DLOnSuspend_label")).click();
		Thread.sleep(2000);

		waitForPublishedQueriesSuspendAlphaDevSuspendTableToLoad();

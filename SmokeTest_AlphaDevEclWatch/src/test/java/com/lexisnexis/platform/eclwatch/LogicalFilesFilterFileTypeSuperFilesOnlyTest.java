...
public class LogicalFilesFilterFileTypeSuperFilesOnlyTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFilesFilterFileTypeSuperFilesOnlyTest() throws Exception {
		...
		Thread.sleep(3000);
		waitForLogicalFilterFileTypeSuperFilesOnlyToLoad();
		assertEquals(".::asuper2", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_LogicalFiles-DLWorkunitsGrid-row---.::asuper2']/table/tr/td[5]/a")).getText().trim());

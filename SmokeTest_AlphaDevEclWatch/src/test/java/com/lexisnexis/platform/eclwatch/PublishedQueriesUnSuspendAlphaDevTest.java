...
public class PublishedQueriesUnSuspendAlphaDevTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testPublishedQueriesUnSuspendAlphaDevTest() throws Exception {
		...
		driver.findElement(By.id("stub_RoxieQueries-DL_Queries-DLUnSuspend_label")).click();
		Thread.sleep(2000);

		waitForPublishedQueriesSuspendAlphaDevUnSuspendTableToLoad();

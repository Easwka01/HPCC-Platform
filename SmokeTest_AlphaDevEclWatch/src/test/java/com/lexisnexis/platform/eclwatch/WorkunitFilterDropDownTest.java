...
public class WorkunitFilterDropDownTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testWorkunitFilterDropDwonTest() throws Exception {
		...
		waitForWorkunittFilterDropDownload();

		// Select the wokunit
		// driver.findElement(By.xpath("//*[@id=\"stub_ECL-DL_Workunits-DLWorkunitsGrid-row-W20190313-144456\"]/table/tr/td[1]")).click();
		// System.out.println("Workunit checkbox should be selected");

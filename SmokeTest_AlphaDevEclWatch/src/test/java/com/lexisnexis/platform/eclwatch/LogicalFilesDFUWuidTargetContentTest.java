...
public class LogicalFilesDFUWuidTargetContentTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFilesDFUWuidTargetContentTest() throws Exception {
		...
		// Click Target Contents Tab
		driver.findElement(By.id("stub_Main-DL_Search-DL_DetailD20180404x102850-DL_DestLogicalName-DLTabContainer_tablist_stub_Main-DL_Search-DL_DetailD20180404x102850-DL_DestLogicalName-DL_Content")).click();
		Thread.sleep(2000);
		System.out.println("Target Contents Tab clicked");
		Thread.sleep(2000);
		waitForLogicalFilesDFUWuidTargetContentToLoad();
		assertEquals("3248", driver.findElement(By.xpath(".//*[@id='stub_Main-DL_Search-DL_DetailD20180404x102850-DL_DestLogicalName-DL_Content-DLGrid-row-.::advtest1_hthor__dev_eclagent_2']/table/tr/td[3]")).getText().trim());
		Thread.sleep(2000);
		System.out.println("DFUWUID Target Content Tab verified");

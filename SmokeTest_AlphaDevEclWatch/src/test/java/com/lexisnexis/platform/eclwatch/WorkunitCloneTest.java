...
public class WorkunitCloneTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testWorkunitCloneTest() throws Exception {
		...
		// Click on Clone Tab
		driver.findElement(By.id("stub_ECL-DL_Workunits-DL_W20190913x093104-DLClone_label")).click();
		Thread.sleep(2000);

		// Click on workunits page
		driver.findElement(By.id("stub_ECL-DL_Workunits-DLTabContainer_tablist_stub_ECL-DL_Workunits-DL_Workunits")).click();
		waitForMineWorkunitload();

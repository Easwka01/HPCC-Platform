...
public class FileXrefOrphanFilesTest extends TestBaseBocaDev {
	...
	public void testFileXrefOrphanFilesTest() throws Exception {
		...
		driver.findElement(By.id("stub_Files-DL_Xref-DL_thor400x126-DLTabContainer_tablist_stub_Files-DL_Xref-DL_thor400x126-DL_OrphanFiles")).click();
		Thread.sleep(4000);
		waitForXrefOrphanFileToLoadAlphDev();
		Thread.sleep(2000);
		assertEquals("Name", driver.findElement(By.xpath("//*[@id=\"stub_Files-DL_Xref-DL_thor400x126-DL_OrphanFiles-DLGrid-header\"]/tr[2]/th[2]/div")).getText().trim());
		assertEquals("Modified", driver.findElement(By.xpath("//*[@id=\"stub_Files-DL_Xref-DL_thor400x126-DL_OrphanFiles-DLGrid-header\"]/tr[2]/th[3]/div")).getText().trim());
		assertEquals("Parts Found", driver.findElement(By.xpath("//*[@id=\"stub_Files-DL_Xref-DL_thor400x126-DL_OrphanFiles-DLGrid-header\"]/tr[2]/th[4]/div")).getText().trim());
		assertEquals("Total Parts", driver.findElement(By.xpath("//*[@id=\"stub_Files-DL_Xref-DL_thor400x126-DL_OrphanFiles-DLGrid-header\"]/tr[2]/th[5]/div")).getText().trim());
		assertEquals("Size", driver.findElement(By.xpath("//*[@id=\"stub_Files-DL_Xref-DL_thor400x126-DL_OrphanFiles-DLGrid-header\"]/tr[2]/th[6]/div")).getText().trim());
	}

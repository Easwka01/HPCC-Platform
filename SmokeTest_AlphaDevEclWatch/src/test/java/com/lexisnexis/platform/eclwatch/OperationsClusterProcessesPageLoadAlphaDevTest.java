...
public class OperationsClusterProcessesPageLoadAlphaDevTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testOperationsClusterProcessesPageLoadAlphaDevTest() throws Exception {
		...
		// Click on Cluster Processes Link
		driver.findElement(By.id("stub_OPS-DLStackController_stub_OPS-DL_ClusterProcessesQuery_label")).click();
		System.out.println("Cluster Processes page loaded");
		waitForOperationsClusterProcessesPageLoad();

...
public class LogicalFilesDFUWuidTargetSummaryTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFilesDFUWuidTargetSummaryTest() throws Exception {
		...
		waitForLogicalFilesDFUWUIDTargetSummaryToLoad();
		assertEquals(".::advtest1", driver.findElement(By.xpath(".//*[@id='stub_Main-DL_Search-DL_DetailD20180404x102850-DL_DestLogicalName-DLName']")).getText().trim());

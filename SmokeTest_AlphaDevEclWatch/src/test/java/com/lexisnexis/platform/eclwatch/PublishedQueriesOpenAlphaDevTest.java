...
public class PublishedQueriesOpenAlphaDevTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testPublishedQueriesOpenAlphaDevTest() throws Exception {
		...
		driver.findElement(By.id("stub_RoxieQueries-DL_Queries-DLOpen_label")).click();
		Thread.sleep(2000);

		// Open page loaded
		driver.findElement(By.id("stub_RoxieQueries-DL_Queries-DL_platformxtestxxxcomprxtestx2-DLBorderContainer")).click();

...
public class FileXrefSummaryTest extends TestBaseBocaDev {
	...
	public void testFileXrefSumamryTest() throws Exception {
		...
		// assertEquals("Last Run:",
		// driver.findElement(By.xpath("//*[@id=\"stub_Files-DL_Xref-DL_thor400x126-DLSummaryForm\"]/ul/li[1]/label")).getText().trim());
		// assertEquals("Last Message:",
		// driver.findElement(By.xpath("//*[@id=\"stub_Files-DL_Xref-DL_thor400x126-DLSummaryForm\"]/ul/li[2]/label")).getText().trim());
		// assertEquals("Found File:",
		// driver.findElement(By.xpath("//*[@id=\"stub_Files-DL_Xref-DL_thor400x126-DLSummaryForm\"]/ul/li[3]/label")).getText().trim());
		// assertEquals("Orphan File:",
		// driver.findElement(By.xpath("//*[@id=\"stub_Files-DL_Xref-DL_thor400x126-DLSummaryForm\"]/ul/li[4]/label")).getText().trim());
		// assertEquals("Lost File:",
		// driver.findElement(By.xpath("//*[@id=\"stub_Files-DL_Xref-DL_thor400x126-DLSummaryForm\"]/ul/li[5]/label")).getText().trim());

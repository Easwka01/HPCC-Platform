...
public class LogicalFilesFilterOwnerTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFilesFilterOwnerTest() throws Exception {
		...
		Thread.sleep(3000);
		assertEquals("varani", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_LogicalFiles-DLWorkunitsGrid-row-hthor__dev_eclagent_2--.::adv:corp:event:sample']/table/tr/td[6]")).getText().trim());

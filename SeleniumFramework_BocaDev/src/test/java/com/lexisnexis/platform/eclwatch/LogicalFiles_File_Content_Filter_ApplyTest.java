...
public class LogicalFiles_File_Content_Filter_ApplyTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFiles_File_Content_Filter_ApplyTest() throws Exception {
		...
		// Click on the filter pop up clear
		driver.findElement(By.id("stub_Files-DL_LogicalFiles-DLToolbar")).click();
		...
		Thread.sleep(5000);
		waitForLogicalFiles_File_ContentFilterTable();

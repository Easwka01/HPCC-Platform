...
public class LogicalFilesFilterFileTypeNotInSuperfilesTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFilesFilterFileTypeNotInSuperfilesTest() throws Exception {
		...
		driver.findElement(By.id("dijit_MenuItem_24_text")).click();

		// Click on Apply
		driver.findElement(By.id("stub_Files-DL_LogicalFiles-DLFilterFilterApply_label")).click();
		Thread.sleep(3000);
		waitForLogicalFilterFileTypeNotInSuperfilesOnlyToLoad();

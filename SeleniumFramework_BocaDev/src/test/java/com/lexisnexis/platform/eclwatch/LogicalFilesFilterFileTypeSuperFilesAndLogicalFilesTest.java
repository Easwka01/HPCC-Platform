...
public class LogicalFilesFilterFileTypeSuperFilesAndLogicalFilesTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFilesFilterFileTypeSuperFilesAndLogicalFilesTest() throws Exception {
		...
		// Select SuperFiles and Logical Files Only
		driver.findElement(By.xpath(".//*[@id='stub_Files-DL_LogicalFiles-DLFileType']/tbody/tr/td[2]/input")).click();
		// driver.findElement(By.id("dijit_MenuItem_82_text")).click();

		// Click on Apply
		driver.findElement(By.id("stub_Files-DL_LogicalFiles-DLFilterFilterApply_label")).click();
		Thread.sleep(3000);
		waitForLogicalFilterFileTypeSuperFilesAndLogicalFilesToLoad();
		// assertEquals("varani",
		// driver.findElement(By.xpath(".//*[@id='stub_Files-DL_LogicalFiles-DLWorkunitsGrid-row-hthor__dev_eclagent_2--.::advtest']/table/tr/td[6]")).getText().trim());

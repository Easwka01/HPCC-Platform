...
public class FileXrefLostFileTest extends TestBaseBocaDev {
	...
	public void testXrefLostFileTest() throws Exception {
		...
		// Click on Lost File
		driver.findElement(By.id("stub_Files-DL_Xref-DL_thor400xdev01-DLTabContainer_tablist_stub_Files-DL_Xref-DL_thor400xdev01-DL_LostFiles")).click();
		Thread.sleep(3000);
		waitForXrefLostFileToLoad();
		Thread.sleep(2000);

...
public class MineButtonRefreshesToWorkunitPageTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testMineButtonRefreshesToWorkunitPageTest() throws Exception {
		...
		// Verify the workunits page loaded
		waitForWorkunitsToLoad();

...
public class LogicalFiles_File_QueriesTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFiles_File_QueriesTest() throws Exception {
		...
		driver.findElement(By.id("stub_Files-DL_LogicalFiles-DL_hthorxxdevxeclagentxxxxxadvtest1-DLTabContainer_tablist_stub_Files-DL_LogicalFiles-DL_hthorxxdevxeclagentxxxxxadvtest1-DL_Queries")).click();
		Thread.sleep(3000);
		waitForLogicalFiles_File_QueriesTable();
		// assertEquals("10.173.14.211",
		// driver.findElement(By.xpath(".//*[@id='stub_Files-DL_LogicalFiles-DL_hthorxxdevxeclagentxxxxxadvtest1-DL_FileParts-DLFilePartsGrid-row-1--1']/table/tr/td[3]")).getText().trim());

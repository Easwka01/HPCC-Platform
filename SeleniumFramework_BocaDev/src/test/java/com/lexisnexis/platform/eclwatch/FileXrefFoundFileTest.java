...
public class FileXrefFoundFileTest extends TestBaseBocaDev {
	...
	public void testFileXrefFoundFileTest() throws Exception {
		...
		// Click on Found File
		driver.findElement(By.id("stub_Files-DL_Xref-DL_thor400xdev01-DLTabContainer_tablist_stub_Files-DL_Xref-DL_thor400xdev01-DL_FoundFiles")).click();
		Thread.sleep(3000);
		waitForXrefFoundFileToLoad();
		System.out.println("XRef found file Loaded");
		assertEquals("Name", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_Xref-DL_thor400xdev01-DL_FoundFiles-DLGrid-header']/tr/th[2]/div")).getText().trim());
		assertEquals("Modified", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_Xref-DL_thor400xdev01-DL_FoundFiles-DLGrid-header']/tr/th[3]/div")).getText().trim());
		assertEquals("Parts", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_Xref-DL_thor400xdev01-DL_FoundFiles-DLGrid-header']/tr/th[4]/div")).getText().trim());
		assertEquals("Size", driver.findElement(By.xpath(".//*[@id='stub_Files-DL_Xref-DL_thor400xdev01-DL_FoundFiles-DLGrid-header']/tr/th[5]/div")).getText().trim());

...
public class LogicalFilesDFUWUIDXmlTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testLogicalFilesWUIDXmlTest() throws Exception {
		...
		// Click on XML Tab
		driver.findElement(By.id("stub_Main-DL_Search-DL_DetailD20180404x102850-DLTabContainer_tablist_stub_Main-DL_Search-DL_DetailD20180404x102850-DL_XML")).click();
		Thread.sleep(2000);
		System.out.println("XML Tab Clicked");
		...
		waitForLogicalFilesDFUWUIDXMLToLoad();
		Thread.sleep(2000);
		System.out.println("XML Tab verified");
	}

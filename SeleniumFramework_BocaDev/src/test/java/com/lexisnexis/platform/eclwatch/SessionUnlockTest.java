...
public class SessionUnlockTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testSessionUnlockTest() throws Exception {
		...
		// Enter password to enter unlock
		driver.findElement(By.id("LockDialogWidget_0UnlockPassword")).sendKeys(properties.getProperty("app.pass"));
		System.out.println("Password entered");
		Thread.sleep(2000);

		// Home page displayed
		waitForHomePage();
		assertEquals("Activity", driver.findElement(By.name("stub_Main-DL_Activity-DLTabContainer_tablist_stub_Main-DL_Activity-DL_Grid")).getText().trim());

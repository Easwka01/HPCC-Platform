...
public class MineButtonRefreshesToLogicalFilesPageTest extends TestBaseBocaDev {

	@Test
	@Timeout(group = Group.SLOW)
	public void testMineButtonRefreshesToLogicalFilesPageTest() throws Exception {
		...
		// Exit the logical files filter set pop up
		// driver.findElement(By.xpath("//*[@id='stub_Files-DL_LogicalFiles-DLWorkunitsGrid-header']/tr/th[5]/div")).click();
		// System.out.println("Logical Files pop up cleared");
		...
		assertEquals("svc-PlatformAuto", driver.findElement(By.xpath("//*[@id='stub_Files-DL_LogicalFiles-DLWorkunitsGrid-row-analyt_thor400_90_a--.::.autofsck']/table/tr/td[6]")).getText().trim());
		...
		// Verify Logical Files page loaded
		waitForLogicalFilesToLoad();
